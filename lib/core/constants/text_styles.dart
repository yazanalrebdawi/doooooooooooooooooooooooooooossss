...
import 'colors.dart'; // AppColors هنا للثوابت الخاصة بالألوان
...
abstract class AppTextStyles {
  ...
  static TextStyle get s12w400 => _baseStyle(fontSize: 12, fontWeight: FontWeight.w400, color: Colors.black);
  static TextStyle get s12w600 => _baseStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Colors.black);
  static TextStyle get s14w400 => _baseStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black);
  static TextStyle get s14w500 => _baseStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Colors.black);
  static TextStyle get s14w600 => _baseStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black);
  static TextStyle get s14w700 => _baseStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Colors.black);
  static TextStyle get s16w400 => _baseStyle(fontSize: 16, fontWeight: FontWeight.w400, color: Colors.black);
  static TextStyle get s16w500 => _baseStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.black);
  static TextStyle get s16w600 => _baseStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.black);
  static TextStyle get s18w500 => _baseStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Colors.black);
  static TextStyle get s18w600 => _baseStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.black);
  static TextStyle get s18w700 => _baseStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.black);
  static TextStyle get s20w400 => _baseStyle(fontSize: 20, fontWeight: FontWeight.w400, color: Colors.black);
  static TextStyle get s20w500 => _baseStyle(fontSize: 20, fontWeight: FontWeight.w500, color: Colors.black);
  static TextStyle get s20w700 => _baseStyle(fontSize: 20, fontWeight: FontWeight.w700, color: Colors.black);
  static TextStyle get s21w600 => _baseStyle(fontSize: 21, fontWeight: FontWeight.w600, color: Colors.black);
  static TextStyle get s22w500 => _baseStyle(fontSize: 22, fontWeight: FontWeight.w500, color: Colors.black);
  static TextStyle get s22w700 => _baseStyle(fontSize: 22, fontWeight: FontWeight.w700, color: Colors.black);
  static TextStyle get s24w600 => _baseStyle(fontSize: 24, fontWeight: FontWeight.w600, color: Colors.black);
  static TextStyle get s25w500 => _baseStyle(fontSize: 25, fontWeight: FontWeight.w500, color: Colors.black);
  static TextStyle get s25w700 => _baseStyle(fontSize: 25, fontWeight: FontWeight.w700, color: Colors.black);
  static TextStyle get s30w600 => _baseStyle(fontSize: 30, fontWeight: FontWeight.w600, color: Colors.black);
  ...
  static TextStyle get whiteS32W700 => _baseStyle(fontSize: 32, fontWeight: FontWeight.w700, color: Colors.white);

  // Gray/Secondary/Hint/Rating Styles
  ...
  static TextStyle get blackS22W500 => s22w500.copyWith(color: Colors.black);
  static TextStyle get blackS22W700 => s22w700.copyWith(color: Colors.black);
  ...
  static TextStyle get blackS30W600 => s30w600.copyWith(color: Colors.black);

  // Headline / Label Styles
...
// Optional: Extension for theme color usage
